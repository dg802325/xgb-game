...
public class MyTomPanel extends JPanel implements Runnable,MouseListener {
	...
	public MyTomPanel() {
		for (int i = 0; i < imgPath_eat.length; i++) {
			imgPath_eat[i]=System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Animations/Eat/eat_"+(i<10?"0":"")+i+".jpg";
		}
		for (int i = 0; i < imgPath_angry.length; i++) {
			imgPath_angry[i]=System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Animations/Angry/angry_"+(i<10?"0":"")+i+".jpg";
		}
		for (int i = 0; i < imgPath_cymbal.length; i++) {
			imgPath_cymbal[i]=System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Animations/Cymbal/cymbal_"+(i<10?"0":"")+i+".jpg";
		}
		for (int i = 0; i < imgPath_drink.length; i++) {
			imgPath_drink[i]=System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Animations/Drink/drink_"+(i<10?"0":"")+i+".jpg";
		}
		for (int i = 0; i < imgPath_fart.length; i++) {
			imgPath_fart[i]=System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Animations/Fart/fart_"+(i<10?"0":"")+i+".jpg";
		}
		for (int i = 0; i < imgPath_footLeft.length; i++) {
			imgPath_footLeft[i]=System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Animations/FootLeft/footLeft_"+(i<10?"0":"")+i+".jpg";
		}
		for (int i = 0; i < imgPath_footRight.length; i++) {
			imgPath_footRight[i]=System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Animations/FootRight/footRight_"+(i<10?"0":"")+i+".jpg";
		}
		for (int i = 0; i < imgPath_knockout.length; i++) {
			imgPath_knockout[i]=System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Animations/Knockout/knockout_"+(i<10?"0":"")+i+".jpg";
		}
		for (int i = 0; i < imgPath_pie.length; i++) {
			imgPath_pie[i]=System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Animations/Pie/pie_"+(i<10?"0":"")+i+".jpg";
		}
		for (int i = 0; i < imgPath_scratch.length; i++) {
			imgPath_scratch[i]=System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Animations/Scratch/scratch_"+(i<10?"0":"")+i+".jpg";
		}
		for (int i = 0; i < imgPath_stomach.length; i++) {
			imgPath_stomach[i]=System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Animations/Stomach/stomach_"+(i<10?"0":"")+i+".jpg";
		}
	...
	public void run() {
		...
		while (true) {
			imgIndex++;
			try {
				btn_eat = ImageIO.read(MyTomPanel.class.getResource(System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Buttons/eat.png"));
				btn_cymbal = ImageIO.read(MyTomPanel.class.getResource(System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Buttons/cymbal.png"));
				btn_drink = ImageIO.read(MyTomPanel.class.getResource(System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Buttons/drink.png"));
				btn_fart = ImageIO.read(MyTomPanel.class.getResource(System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Buttons/fart.png"));
				btn_pie = ImageIO.read(MyTomPanel.class.getResource(System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Buttons/pie.png"));
				btn_scratch = ImageIO.read(MyTomPanel.class.getResource(System.getProperty("user.dir")+"/xgb-tom/src/main/java/com/xgb/img/Buttons/scratch.png"));
