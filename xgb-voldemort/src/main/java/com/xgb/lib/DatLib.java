...
import com.xgb.characters.NPC;
import com.xgb.characters.Player;
import com.xgb.characters.ResLevelupChain;
import com.xgb.characters.SceneObj;
import com.xgb.goods.BaseGoods;
import com.xgb.goods.GoodsDecorations;
...
import com.xgb.goods.GoodsMedicineChg4Ever;
import com.xgb.goods.GoodsMedicineLife;
import com.xgb.goods.GoodsStimulant;
import com.xgb.goods.GoodsTudun;
import com.xgb.goods.GoodsWeapon;
import com.xgb.magic.MagicAttack;
import com.xgb.magic.MagicAuxiliary;
import com.xgb.magic.MagicEnhance;
import com.xgb.magic.MagicRestore;
import com.xgb.magic.MagicSpecial;
import com.xgb.magic.ResMagicChain;
...
public final class DatLib {
	...
	private DatLib() throws IOException {
		InputStream in = null;
		try {
			in = new FileInputStream(new File(System.getProperty("user.dir")+"/xgb-voldemort/src/main/java/com/xgb/assets/"+FILE_NAME));
